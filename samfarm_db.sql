...
(1, 'Sasuke', '123456789dfg', 'por ahi no recuerdo', '75767565656', 'contacto@samfarm.com', 'http://localhost/samfarm-backend/views/assets/img/logo_empresa_2285f77ce9add384_1764983826.png', '2025-11-19 01:22:36', '2025-12-13 19:24:28');
...
CREATE TABLE `historial_lote` (
  ...
  `us_id` bigint(20) UNSIGNED DEFAULT NULL,
  `hl_accion` enum('creacion','activacion','ajuste','caducidad','terminacion','devolucion','bloqueo','desbloqueo','transferencia_salida','transferencia_entrada','recepcion_transferencia','rechazo_transferencia') NOT NULL,
...
CREATE TABLE `lote_medicamento` (
  ...
  `lm_costo_lista` decimal(12,2) DEFAULT NULL,
  `lm_precio_compra` decimal(12,2) DEFAULT NULL,
  `lm_precio_venta` decimal(12,2) DEFAULT NULL,
  `lm_margen_u` decimal(5,2) DEFAULT NULL,
  `lm_margen_c` decimal(5,2) DEFAULT NULL,
  `lm_precio_min_u` decimal(12,2) DEFAULT NULL,
  `lm_precio_min_c` decimal(12,2) DEFAULT NULL,
...
CREATE TABLE `movimiento_inventario` (
  ...
  `mi_referencia_id` varchar(200) DEFAULT NULL,
...
--
ALTER TABLE `clientes`
  MODIFY `cl_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=20;
